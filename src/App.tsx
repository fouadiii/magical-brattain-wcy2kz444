import { SaveAll, SquareChevronDown } from "lucide-react";
...
const RotationSchedule = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Rotation Schedule</h1>
      <button
      ...
      <table className="w-full border-collapse border border-gray-400">
        <thead>
          <tr>
            ...
            <th className="border border-gray-400 p-2">Worker 1</th>
            <th className="border border-gray-400 p-2">Worker 2</th>
            <th className="border border-gray-400 p-2">Worker 3</th>
          </tr>
        </thead>
        <tbody>
